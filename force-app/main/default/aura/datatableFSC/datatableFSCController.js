({
    init: function (cmp, event, helper) {
        ...
        //this was commented out, removing the comment to test out the refund table functionality 
        //@anshul on 2/22
    ...
    getSelectedName: function (cmp, event) {
       ...
       console.log("v.selectedRows_custom2"+cmp.get("v.selectedRows_custom2")); 
    ...
    handleSave: function(cmp, event, helper) {
        ...
        if(cmp.get('v.showButtons')) {
            ...
            console.log("cmp.get('v.mydata')"+JSON.stringify(cmp.get('v.mydata')));
            cmp.set('v.saveMydata', cmp.get('v.mydata'));
        }
    },
